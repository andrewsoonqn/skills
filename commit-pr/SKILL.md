---
name: commit-pr
description: Use when committing, pushing, or opening a pull request, and when reviewing or rewriting a commit message or suggesting a branch name. Owns the user's commit-message conventions and is fork/remote/base-aware.
---
